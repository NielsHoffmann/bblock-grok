...
```jsonld
{
  "@context": [
    ...
    "https://nielshoffmann.github.io/bblock-grok/build/annotated/grok/myFeature/context.jsonld",
    {
      "mynamespace": "http://example.org/ns1/"
    }
  ],
...
$defs:
  MyFeature:
    ...
    - properties:
        properties:
          $ref: https://nielshoffmann.github.io/bblock-grok/build/annotated/grok/mySchema/schema.yaml
anyOf:
- $ref: '#/$defs/MyFeature'
...
* YAML version: [schema.yaml](https://nielshoffmann.github.io/bblock-grok/build/annotated/grok/myFeature/schema.json)
* JSON version: [schema.json](https://nielshoffmann.github.io/bblock-grok/build/annotated/grok/myFeature/schema.yaml)
...
[context.jsonld](https://nielshoffmann.github.io/bblock-grok/build/annotated/grok/myFeature/context.jsonld)
